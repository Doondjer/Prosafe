...
return [
    ...
    |
    */
    'title' => 'Panel Za Proveru Stanja Servera',
    ...
    */
    ...
    'services' => [
        'ping' => [
            'bin' => env('HEALTH_PING_BIN', '/usr/bin/ping'),
        ],
    ...
    'notifications' => [
        ...
        'action_message' => "'%s' servis je u problemu i traži vašu pažnju%s",
    ...
    'views' => [
        'panel' => 'vendor.pragmarx.health.default.panel',//'pragmarx/health::default.panel',

        'empty-panel' => 'pragmarx/health::default.empty-panel',

        'partials' => [
            'well' => 'vendor.pragmarx.health.default.partials.well',//'pragmarx/health::default.partials.well',
        ],
    ],
