        ...
        <div class="row align-items-center">
            <div class="col-3">
                ...
                @elseif($item['name'] === 'Emergency')
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-bug" width="24"
                         height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                         stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                ...
                @elseif($item['name'] === 'Critical')
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-heart-broken" width="24"
                         height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                         stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                ...
                @elseif($item['name'] === 'Warning')
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-flag" width="24"
                         height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                         stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                ...
                @elseif($item['name'] === 'Debug')
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-radioactive" width="24"
                         height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                         stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
            ...
            <div class="col">
                <h3 class="card-title mb-1">
                    <span class="text-reset">{{ $item['name'] }}</span>
                </h3>
                <div class="card-number">
                    {{ $item['count'] }} @choice('log-viewer.entries', $item['count']) - {!! $item['percent'] !!} %
                </div>
                <div class="mt-3">
                    <div class="row g-2 align-items-center">
                        <div class="col-auto card-number">
                            {!! $item['percent'] !!}%
                        </div>
                        <div class="col">
                            <div class="progress progress-sm">
                                <div class="progress-bar" style="width: {!! $item['percent'] !!}%" role="progressbar"
                                    ...
                                    <span class="visually-hidden"> {{ $item['count'] }} @choice('log-viewer.entries', $item['count']) - {!! $item['percent'] !!}%</span>
                                </div>
                            </div>
                        </div>
                    </div>
